...
func (o *UploadFileReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[POST /pet/{petId}/uploadImage] uploadFile", response, response.Code())
	}
}
...
func (o *UploadFileOK) Error() string {
	...
	return fmt.Sprintf("[POST /pet/{petId}/uploadImage][%d] uploadFileOK %s", 200, payload)
}
...
func (o *UploadFileOK) GetPayload() *models.APIResponse {
	return o.Payload
}

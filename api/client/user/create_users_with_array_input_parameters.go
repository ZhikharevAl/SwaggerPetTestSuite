...
CreateUsersWithArrayInputParams contains all the parameters to send to the API endpoint
	...
	for the create users with array input operation.
...
// WithDefaults hydrates default values in the create users with array input params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CreateUsersWithArrayInputParams) WithDefaults() *CreateUsersWithArrayInputParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the create users with array input params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CreateUsersWithArrayInputParams) SetDefaults() {
